...
export const environment = {
  ...
  //  dropdown API
  GetFCPoleData: '/api/Dropdown/getFCPoleData',
  GetRegionData: '/api/Dropdown/getRegionData',
  GetCountryData: '/api/Dropdown/getCountryData',
  GetAccountSiteData: '/api/Dropdown/getAccountSiteData',

  // site cyber records 
  GetMaturitySatusMaster: '/api/Master/getMaturitySatusMaster',
  SaveMaturitySatusMaster: '/api/Master/saveMaturitySatusMaster',
};
